...
with tab1:
    ...
    with col_out:
        ...
        # ── Score bars + gauge side-by-side ─────────────────────────────────
        bar_col, gauge_col = st.columns([1.1, 1], gap="medium")
        with bar_col:
        ...
        # ── Loading Calculation Summary ───────────────────────────────────────
        st.markdown(
            "<div style='height:0.5rem'></div>"
            "<div style='font-size:0.6rem;font-weight:700;letter-spacing:0.14em;"
            "text-transform:uppercase;color:var(--text-muted);"
            "padding-bottom:0.5rem;border-bottom:1px solid var(--border);margin-bottom:0.1rem'>"
            "Loading Calculation Summary</div>",
            unsafe_allow_html=True
        )
        _t1_rows = [
...
with tab2:
    ...
    with col_out2:
        ...
        bar_col2, gauge_col2 = st.columns([1.1, 1], gap="medium")
        with bar_col2:
