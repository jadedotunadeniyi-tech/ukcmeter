...
with tab1:
    ...
    # ── Three-column layout ──────────────────────────────────────────────────
    # LEFT: limit panel + volume input + UKC gauge (fills the empty space)
    # CENTRE: result panel + score bars
    # RIGHT: loading calculation summary table + download
    col_inp, col_res, col_tbl = st.columns([1, 1.1, 1.1], gap="large")
    ...
    with col_inp:
        ...
        # ── UKC Gauge sits here, directly under the cargo volume input ──
        # (computed after col_res block — placeholder rendered after res is ready)
        _gauge_placeholder = st.empty()
    ...
    # ── Now render the gauge into the left-column placeholder ───────────────
    with _gauge_placeholder:
...
with tab2:
    ...
    # ── Three-column layout: inputs+gauge left | results centre | summary right
    c_d1, c_d2, c_d3 = st.columns([1, 1.1, 1.1], gap="large")
    ...
    with c_d1:
        ...
        # ── UKC Gauge sits here, under the draft input ──
        _gauge_placeholder2 = st.empty()
    ...
    # ── Render gauge into left-column placeholder ────────────────────────────
    with _gauge_placeholder2:
