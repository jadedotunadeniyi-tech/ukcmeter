...
with tab1:
    ...
    with col_out:
        ...
        # ── UKC Gauge full-width (matches hero card width) ───────────────────
        ukc_badge(ukc["ukc_status"], ukc["ukc_m"], ukc["ukc_required_m"], water_depth, res["draft_m"])

        # ── Loading Calculation Summary full-width ────────────────────────────
        st.markdown(
            "<div style='height:0.25rem'></div>"
            "<div style='font-size:0.6rem;font-weight:700;letter-spacing:0.14em;"
            "text-transform:uppercase;color:var(--text-muted);"
            "padding-bottom:0.5rem;border-bottom:1px solid rgba(255,255,255,0.08);margin-bottom:0.1rem'>"
